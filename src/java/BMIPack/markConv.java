...
public class markConv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int mark = Integer.parseInt(request.getParameter("markTextBox"));
            int gradeCheck = Integer.parseInt(request.getParameter("gradeCheckBox"));
            int pointCheck = Integer.parseInt(request.getParameter("pointCheckBox"));
